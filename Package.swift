    ...
    targets: [
        ...
        .testTarget(
            ...
            resources: [
                ...
                .copy("Resources/account_akkoma_miraiverse.json"),
                ...
                .copy("Resources/instancev1_pixelfed.json"),
                .copy("Resources/instancev1_pixelfed_tokyo.json"),
                ...
                .copy("Resources/post_attachments.json"),
